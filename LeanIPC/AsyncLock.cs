...
namespace LeanIPC
{
	...
	public class AsyncLock
	{
		...
		public struct Releaser : IDisposable
		{
			...
			/// <summary>
			/// Initializes a new instance of the <see cref="AsyncLock.Releaser"/> struct.
			/// </summary>
			...
			/// <summary>
			/// Releases all resource used by the <see cref="AsyncLock.Releaser"/> object.
			/// </summary>
			/// <remarks>Call <see cref="Dispose"/> when you are finished using the <see cref="AsyncLock.Releaser"/>. The
			/// <see cref="Dispose"/> method leaves the <see cref="AsyncLock.Releaser"/> in an unusable state. After
			/// calling <see cref="Dispose"/>, you must release all references to the <see cref="AsyncLock.Releaser"/> so
			/// the garbage collector can reclaim the memory that the <see cref="AsyncLock.Releaser"/> was occupying.</remarks>
			public void Dispose()
			{
				if (m_parent != null)
					lock (m_parent)
