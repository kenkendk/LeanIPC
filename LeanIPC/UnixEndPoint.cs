...
namespace LeanIPC
{
    ...
    internal class UnixEndPoint : EndPoint
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UnixEndPoint"/> class.
        /// </summary>
        ...
        {
            byte[] bytes = System.Text.Encoding.UTF8.GetBytes(m_path);
        ...
        /// <summary>
        /// Returns a <see cref="T:System.String"/> that represents the current <see cref="UnixEndPoint"/>.
        /// </summary>
        /// <returns>A <see cref="T:System.String"/> that represents the current <see cref="UnixEndPoint"/>.</returns>
        ...
        /// <summary>
        /// Serves as a hash function for a <see cref="UnixEndPoint"/> object.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the specified <see cref="object"/> is equal to the current <see cref="UnixEndPoint"/>.
        /// </summary>
        /// <param name="o">The <see cref="object"/> to compare with the current <see cref="UnixEndPoint"/>.</param>
        /// <returns><c>true</c> if the specified <see cref="object"/> is equal to the current
        /// <see cref="UnixEndPoint"/>; otherwise, <c>false</c>.</returns>
